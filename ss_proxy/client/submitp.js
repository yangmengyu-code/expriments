...
const url = "https://verygood.us.kg/autosubmit/?reqmode=p2&realip=" + ipv4;
// const url = "https://verygood.us.kg/autosubmit/?reqmode=p2";
// 全局忽略任何异常避免退出
...
async function start() {
  ...
  // while (count <= MaxCount) {
    // console.log("\n\n\n");
    // console.log("================================");
    // console.log("Shadowsocks Request Count:", count);
